...
# Pattern 5 hit probabilities (for rare weapons)
...
def calculate_weapon_attributes(
    weapon_data: Dict,
    drop_area: str,
) -> Dict[str, float]:
    """
...
def get_hit_probability(drop_area: Optional[str] = None) -> float:
    ...
    if isinstance(area_rates, dict):
        ...
        # Dataclass format
        total_rate = (
            area_rates.native + area_rates.abeast + area_rates.machine +
            area_rates.dark + area_rates.hit + area_rates.no_attribute
        )
        if total_rate == 0:
            return 0.0
        return area_rates.hit / total_rate
...
# Pattern attribute value probabilities by area
AREA_ATTRIBUTE_RATES: Dict[str, AreaAttributeRates] = {
    # Episode 1
    "Forest 1": AreaAttributeRates(30, 19, 13, 8, 5, 25),
    "Forest 2": AreaAttributeRates(30, 19, 13, 8, 5, 25),
    "Cave 1": AreaAttributeRates(11, 30, 19, 10, 5, 25),
    "Cave 2": AreaAttributeRates(11, 30, 19, 10, 5, 25),
    "Cave 3": AreaAttributeRates(9, 30, 21, 10, 5, 25),
    "Mine 1": AreaAttributeRates(6, 12, 32, 20, 5, 25),
    "Mine 2": AreaAttributeRates(6, 12, 32, 20, 5, 25),
    "Ruins 1": AreaAttributeRates(20, 7, 11, 32, 5, 25),
    "Ruins 2": AreaAttributeRates(20, 7, 11, 32, 5, 25),
    "Ruins 3": AreaAttributeRates(13, 13, 12, 32, 5, 25),
    
    # Episode 2
    "VR Temple Alpha": AreaAttributeRates(15, 10, 10, 10, 5, 50),
    "VR Temple Beta": AreaAttributeRates(10, 10, 15, 10, 5, 50),
    "VR Spaceship Alpha": AreaAttributeRates(15, 10, 10, 10, 5, 50),
    "VR Spaceship Beta": AreaAttributeRates(10, 10, 10, 15, 5, 50),
    "Jungle Area North": AreaAttributeRates(15, 10, 10, 10, 5, 50),
    "Jungle Area East": AreaAttributeRates(10, 15, 10, 10, 5, 50),
    "Mountain Area": AreaAttributeRates(10, 10, 10, 15, 5, 50),
    "Seaside Area": AreaAttributeRates(10, 10, 15, 10, 5, 50),
    "Central Control Area": AreaAttributeRates(10, 10, 15, 10, 5, 50),
    "Seabed Upper Levels": AreaAttributeRates(15, 10, 15, 10, 5, 45),
    "Seabed Lower Levels": AreaAttributeRates(10, 15, 10, 15, 5, 45),
    "Control Tower": AreaAttributeRates(10, 15, 10, 15, 5, 45),
    
    # Episode 4
    "Crater East": AreaAttributeRates(15, 10, 10, 10, 5, 50),
    "Crater West": AreaAttributeRates(10, 10, 10, 15, 5, 50),
    "Crater South": AreaAttributeRates(15, 10, 10, 10, 5, 50),
    "Crater North": AreaAttributeRates(10, 15, 10, 10, 5, 50),
    "Crater Interior": AreaAttributeRates(10, 10, 10, 15, 5, 50),
    "Subterranean Desert 1": AreaAttributeRates(10, 10, 15, 10, 5, 50),
    "Subterranean Desert 2": AreaAttributeRates(15, 10, 15, 10, 5, 45),
    "Subterranean Desert 3": AreaAttributeRates(10, 15, 10, 15, 5, 45),

    "Default": AreaAttributeRates(11, 11, 11, 11, 5, 51),
}

# Area pattern selection - maps area to pattern names and pattern numbers
# The pattern numbers (e.g., [2, 1, 0]) indicate:
# - How many attributes roll (non-zero numbers)
# - Which pattern each uses (the number itself)
# Pattern 0 = 5-10%, Pattern 1 = 10-20%, Pattern 2 = 20-30%, etc.
AREA_PATTERNS: Dict[str, PatternConfig] = {
    "Forest 1": PatternConfig("Forest 1", ["VR Temple Alpha", "-", "-"], [2, 1, 0]),
    "Forest 2": PatternConfig("Forest 2", ["VR Temple Beta", "-", "-"], [2, 1, 0]),
    "Cave 1": PatternConfig("Cave 1", ["VR Spaceship Alpha", "Crater East", "-"], [2, 2, 1]),
    "Cave 2": PatternConfig("Cave 2", ["VR Spaceship Beta", "Crater West", "-"], [3, 2, 1]),
    "Cave 3": PatternConfig("Cave 3", ["Jungle Area North", "Crater South", "-"], [3, 3, 2]),
    "Mine 1": PatternConfig("Mine 1", ["Jungle Area East", "Crater North", "-"], [3, 3, 2]),
    "Mine 2": PatternConfig("Mine 2", ["Mountain Area", "Crater Interior", "-"], [3, 3, 3]),
    "Ruins 1": PatternConfig("Ruins 1", ["Seaside Area", "Central Control Area", "Subterranean Desert 1"], [4, 3, 3]),
    "Ruins 2": PatternConfig("Ruins 2", ["Seabed Upper Levels", "Subterranean Desert 2", "-"], [4, 4, 3]),
    "Ruins 3": PatternConfig("Ruins 3", ["Seabed Lower Levels", "Control Tower", "Subterranean Desert 3"], [4, 4, 4]),
}
...
# Pattern 5 hit value probabilities (for rare weapons)
# First roll for hit, then roll on Pattern 5 to determine hit value
PATTERN_5_HIT_PROBABILITIES = {
    5: 0.2921,
    10: 0.2309,
    15: 0.1908,
